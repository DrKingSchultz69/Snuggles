      ...
      <section className="py-24 px-4 md:px-12 bg-white">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 space-y-8 text-center">
            <h2 className="text-2xl font-serif italic lg:relative lg:-left-6">Founder's Note</h2>
            <p className="leading-relaxed text-muted-foreground font-light text-sm lg:relative lg:-left-6">
            ...
            <p className="uppercase tracking-widest text-sm lg:relative lg:-left-6">— Shimona, Founder</p>
          </div>
        </div>
      </section>
